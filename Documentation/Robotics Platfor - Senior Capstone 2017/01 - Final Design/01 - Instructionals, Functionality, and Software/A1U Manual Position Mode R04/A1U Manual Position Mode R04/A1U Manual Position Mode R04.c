...
volatile float		voltSet1 = 0;			//Set voltage motor 1
volatile float		voltSet2 = 0;			//Set voltage motor 2
volatile float		digiHB1 = 0;			//Starting digital H Bridge 1 value
volatile float		digiHB2 = 0;			//Starting digital H Bridge 2 value
...
/** Control Parameters **/
volatile float Kp = 0.;						//Proportional Gain (varies according to input speed in code)
volatile float Ki = 0.05;					//Integral control constant (constant over range)
...
volatile float amplitude = 5;			//Input amplitude in degrees (as measured from horizontal, not peak to peak)
