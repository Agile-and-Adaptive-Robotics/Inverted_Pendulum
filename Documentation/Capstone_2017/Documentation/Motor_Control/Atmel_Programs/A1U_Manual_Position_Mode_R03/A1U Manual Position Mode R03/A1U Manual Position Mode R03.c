...
volatile float amplitude = 5.0;			//Input amplitude in degrees (as measured from horizontal, not peak to peak)
volatile float frequency = 0.3;			//Input frequency in Hz
volatile uint8_t numberofCycles = 5;	//Number of cycles desired
